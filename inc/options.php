<?php
/*
Class slides helped us completed this!
Thanks code diva
*/
...
/*
This called to the section callback, it echos what the page will say.
*/
function cd_options_page_section_callback() { 
		echo 'A description and detail about the section.';
	}
/*
these show the fields and the information displayed
*/
	add_settings_field( 
		'cd_text_field', 
		'Enter your text', 
